...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    ...
    const applicationId = req.params.id || req.body.outdoor_work_application_id || 'temp';
    const folderPath = path.join(uploadDir, 'outdoor-work-documents', applicationId.toString());
