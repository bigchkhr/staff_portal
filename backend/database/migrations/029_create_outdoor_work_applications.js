exports.up = function(knex) {
  return knex.schema.createTable('outdoor_work_applications', function(table) {
    ...
    table.string('start_location', 255); // 開始地點
    table.string('end_location', 255); // 結束地點
    table.string('transportation', 255); // 交通工具
    table.decimal('expense', 10, 2); // 費用
    table.text('purpose'); // 目的
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('outdoor_work_applications');
};
